...
document
  ...
  .addEventListener("change", function cambiarFoto() {
    let nombre = document.getElementById("animal");
    if (nombre.value == "Leon") {
      img.innerHTML = `<img src="./assets/imgs/Leon.png" alt="imagen_leon" width= "200" heigth="200">`;
    } else if (nombre.value == "Lobo") {
      img.innerHTML = `<img src="./assets/imgs/Lobo.jpg" alt="imagen_lobo" width= "200" heigth="200">`;
    } else if (nombre.value == "Oso") {
      img.innerHTML = `<img src="./assets/imgs/Oso.jpg" alt="imagen_oso" width= "200" heigth="200">`;
    } else if (nombre.value == "Serpiente") {
      img.innerHTML = `<img src="./assets/imgs/Serpiente.jpg" alt="imagen_serpiente" width= "200" heigth="200">`;
    } else if (nombre.value == "Aguila") {
      img.innerHTML = `<img src="./assets/imgs/Aguila.png" alt="imagen_aguila" width= "200" heigth="200">`;
    }
  });
...
window.verDatos = (entry)=>{
    ...
    <div>
    <div>
    <img src="./assets/imgs/${datos.getImg()}" style="width: 200" />
    </div>
